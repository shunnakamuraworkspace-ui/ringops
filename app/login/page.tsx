    ...
    <div className="mt-6 grid overflow-hidden border-y-2 border-slate-950 bg-white lg:grid-cols-2">
      <section className="border-b border-slate-200 p-6 lg:border-b-0 lg:border-r lg:p-8">
        ...
        <form action={signIn} className="mt-6 space-y-4">
          <Field label="メールアドレス"><input className="input" name="email" type="email" required /></Field>
          <Field label="パスワード"><input className="input" name="password" type="password" minLength={8} required /></Field>
      ...
      <section className="p-6 lg:p-8">
        ...
        <form action={signUp} className="mt-6 space-y-4">
          <Field label="表示名"><input className="input" name="displayName" required /></Field>
          <Field label="メールアドレス"><input className="input" name="email" type="email" required /></Field>
          <Field label="パスワード（8文字以上）"><input className="input" name="password" type="password" minLength={8} required /></Field>
