...
export const boxerPreviewData: BoxerPreview[] = [
  { id:"20000000-0000-4000-8000-000000000001", name:"山田 直樹", kana:"やまだ なおき", gym:"青空ボクシングジム", prefecture:"東京都", nationality:"日本", division:"スーパーバンタム級", boxerClass:"B級", stance:"右", totalBouts:8, wins:6, losses:2, draws:0, koWins:3, rankings:[], lastBout:"2026.06.12", nextBout:null, nextVenue:null, status:"受付中", available:"2026年11月以降", availableMonth:"2026-11", rounds:[6], minWeight:55.0, maxWeight:55.5, travel:"国内可", verified:"3日前", heightCm:169, reachCm:171, birthDate:"2000-02-14", instagram:"https://instagram.com/" },
  { id:"20000000-0000-4000-8000-000000000002", name:"佐藤 海斗", kana:"さとう かいと", gym:"東都ファイトジム", prefecture:"東京都", nationality:"日本", division:"スーパーバンタム級", boxerClass:"B級", stance:"左", totalBouts:7, wins:5, losses:1, draws:1, koWins:2, rankings:[{body:"日本",rank:14}], lastBout:"2026.05.28", nextBout:"2026.09.18", nextVenue:"後楽園ホール", status:"条件次第", available:"次戦後に相談可", availableMonth:"2026-11", rounds:[6,8], minWeight:54.5, maxWeight:55.5, travel:"要相談", verified:"今日", heightCm:171, reachCm:174, birthDate:"1999-08-02" },
  { id:"20000000-0000-4000-8000-000000000003", name:"鈴木 蓮", kana:"すずき れん", gym:"港町ボクシングクラブ", prefecture:"神奈川県", nationality:"日本", division:"フェザー級", boxerClass:"A級", stance:"右", totalBouts:13, wins:10, losses:3, draws:0, koWins:6, rankings:[{body:"OPBF",rank:11},{body:"日本",rank:8}], lastBout:"2026.07.03", nextBout:"2026.10.08", nextVenue:"後楽園ホール", status:"受付停止", available:"—", availableMonth:"", rounds:[8], minWeight:57.0, maxWeight:57.5, travel:"国内可", verified:"5日前", heightCm:173, reachCm:176, birthDate:"1997-11-19" },
  { id:"20000000-0000-4000-8000-000000000004", name:"高橋 悠真", kana:"たかはし ゆうま", gym:"北辰ボクシングジム", prefecture:"埼玉県", nationality:"日本", division:"ライト級", boxerClass:"C級", stance:"左", totalBouts:3, wins:2, losses:1, draws:0, koWins:1, rankings:[], lastBout:"2026.04.21", nextBout:null, nextVenue:null, status:"受付中", available:"今すぐ", availableMonth:"2026-09", rounds:[4], minWeight:61.0, maxWeight:61.5, travel:"関東のみ", verified:"8日前", heightCm:175, reachCm:178, birthDate:"2002-05-06" },
